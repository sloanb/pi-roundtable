...
Update examples:
  pi-roundtable --check-only          # Check for updates
  pi-roundtable --update              # Interactive update
  pi-roundtable --update --yes        # Non-interactive update (CI/CD)
  pi-roundtable --update --channel prerelease  # Update to pre-release
  pi-roundtable --rollback            # Rollback to previous version
