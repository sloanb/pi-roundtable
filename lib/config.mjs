...
import { suggestCandidates, formatSuggestions } from "./suggest.mjs";
...
export function resolvePresetName({ name, presets, config }) {
	...
	// Suggest the nearest preset or alias for typos ("design-revew").
	const suggestions = suggestCandidates(name, [
		...Object.keys(presets),
		...aliasList,
	]);
	throw new ConfigError(
